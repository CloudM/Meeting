...
<body>
	...
	<div class="navbar navbar-default navbar-fixed-top" role="navigation" style="height: 50px;">
		...
		<div class="container">
			<div class="row">
				...
				<div class="qrcode-form">
					...
					<form class="form-horizontal" action="${pageContext.request.contextPath}/CardAction?method=CreatCard" method="post">
					<div id="qrcode-card">
						<div class="form-tit">创建电子名片
							</div>
							<hr>
						<!-- <div class="form-row">
							<span class="row-th">分类</span>
							<select id="category_id">
								<option value="0">默认分类</option>
								<option value="531">同事</option>
								<option value="7">朋友</option>
								<option value="5">家人</option>
							</select>
							<a class="hide" id="add_category" href="javascript:vlid(0);">+ 添加分类</a>
						</div> -->
						
						<div class="form-row">
							<span class="row-th" id="lnag_cdn">姓名</span>
							<input class="form-qrtext-mini" id="text_cdn" type="text" placeholder="输入姓名" value="" name="username">
						...
						<div class="form-row">
							...
							<input class="form-qrtext-mini" id="text_cdorg" type="text" placeholder="输入公司名称" value="" name="company">
							<span class="row-th" id="lnag_cdtitle">职位</span>
							<input class="form-qrtext-mini" id="text_cdtitle" type="text" placeholder="输入职称" value="" name="position">
							...
							<div class="form-row">
								...
								<input class="form-qrtext-mini" id="text_cdtel" type="text" placeholder="输入手机" value="" name="phone">
								<span class="row-th" id="lnag_cdtel1">工作电话</span>
								<input class="form-qrtext-mini" id="text_cdtel1" type="text" placeholder="输入工作电话" value="">
							<!-- <span class="row-th" id="lnag_cdtel2">家庭电话</span>
								<input class="form-qrtext-mini" id="text_cdtel2" type="text" placeholder="输入家庭电话" value=""> -->
							</div>


							<div class="form-row">
								<span class="row-th" id="lnag_cdemail">邮箱</span>
								<input class="form-qrtext-small" id="text_cdemail" type="text" placeholder="输入邮箱地址" value="" name="email">
						...
						<!-- <div class="form-row">
							<span class="row-th" id="lnag_cdadrhome">家庭地址</span>
							<input class="form-qrtext-small" id="text_cdadrhome" type="text" placeholder="输入家庭地址" value="">
						</div> -->

						<div class="form-row">
							<span class="row-th" id="lnag_cdnote">备注</span>
							<input class="form-qrtext-small" id="text_cdnote" type="text" placeholder="输入备注" value="" name="introduction">
						</div>
		...
		<script type="text/javascript" src="../js/createcard.js"></script>
