<%@ page language="java" import="com.entity.User"
...
<link href="../css/center-card-my.css" rel="stylesheet" type="text/css">
	...
	<div class="container" id="container1">
		...
		<div class="user-info clearfix">
			...
			<div class="user-info-right">
				...
				<!--25-->
				<p class="about-info">
					<span>男</span> <span>湖北</span> <span>武汉市</span> <span>学生</span>
				</p>
			</div>
		...
		<div class="row">
			<div class="col-xs-2">
				<div class="nav1">
					...
					<ul>
						<li class="nav-item"><a href="center.html"><i
								class="fa fa-user-circle fa-lg"></i><span>个人信息</span></a></li>
						<li class="nav-item"><a href="javascript:;"><i
								class="fa fa-calendar fa-lg"></i><span>我参加的会议</span><i
						...
						<li class="nav-item"><a href="javascript:;"><i
								class="fa fa-gg-circle fa-lg"></i><span>我发布的会议</span><i
								class="my-icon nav-more"></i></a>
							<ul>
								<li><a href="center-org-script.html"><span>草稿箱</span></a></li>
								<li><a href="center-org-have.html"><span>已发布会议</span></a></li>
								<li><a href="center-org-fini.html"><span>已完成会议</span></a></li>
							</ul></li>
						<li class="nav-item"><a href="javascript:;"><i
								class="fa fa-address-card fa-lg"></i><span>名片夹</span><i
								class="my-icon nav-more"></i></a>
							<ul style="display: block;">
								<li class="active"><a href="center-card-my.html"><span>我的名片</span></a></li>
			...
			<div class="col-xs-10">
				...
				<div class="card">
					...
					<div class="companyinfo">
						...
						<span class="company1"></span> <span class="company2"></span>
					</div>

					<div class="contactinfo">
						<span class="glyphicon glyphicon-phone contact1"
							style="color: #FFFFF0"></span>&nbsp;手机号： <span class="phonenum"></span>

						<span class="glyphicon glyphicon-phone-alt contact2"
							style="color: #FFFFF0"></span>&nbsp;工作电话： <span class="worknum"></span>
					</div>
				...
				<div class="ope">
					<div class="leftbut">
						<button class="btn btn-success" data-toggle="modal" data-target="#change">修改名片</button>
					</div>
					<div class="righttbut">
						<button class="btn btn-danger" data-toggle="modal" data-target="#delete">删除名片</button>
					</div>
				</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">修改名片</h4>
					</div>
					...
					<div id="qrcode-card">
						...
						<div class="form-row">
							...
							<input class="form-qrtext-mini" id="text_cdn" type="text" placeholder="输入姓名" value="">
						...
						<div class="form-row">
							...
							<input class="form-qrtext-mini" id="text_cdorg" type="text" placeholder="输入公司名称" value="">
							<span class="row-th" id="lnag_cdtitle">职位</span>
							<input class="form-qrtext-mini" id="text_cdtitle" type="text" placeholder="输入职称" value="">
							<!-- <span class="row-th" id="lnag_cdurl">主页</span>
								<input class="form-qrtext-mini" id="text_cdurl" type="text" placeholder="网址 http:// 开头" value=""> -->
							</div>

							<div class="form-row">
								<span class="row-th" id="lnag_cdtel">手机</span>
								<input class="form-qrtext-mini" id="text_cdtel" type="text" placeholder="输入手机" value="">
								<span class="row-th" id="lnag_cdtel1">工作电话</span>
								<input class="form-qrtext-mini" id="text_cdtel1" type="text" placeholder="输入工作电话" value="">
							...
							<div class="form-row">
								...
								<input class="form-qrtext-small" id="text_cdemail" type="text" placeholder="输入邮箱地址" value="">

							</div>

							<div class="form-row">
								<span class="row-th" id="lnag_cdadr">工作地址</span>
								<input class="form-qrtext-small" id="text_cdadr" type="text" placeholder="输入工作地址" value="">
							</div>
						...
						<div class="form-row">
							...
							<input class="form-qrtext-small" id="text_cdnote" type="text" placeholder="输入备注" value="">
						</div>
