 ...
 <div class="navbar navbar-default navbar-fixed-top" role="navigation" style="height: 50px;">
    ...
    <div class="container">
      <div class="row">
		...
		<div class="plus" style="width: 50%;margin-left:auto;margin-right: auto;text-align:center;position: relative;top: 50%;transform: translateY(-50%);">
			<a href="${pageContext.request.contextPath}/jsp/CreatCard.jsp"><i class="fa fa-plus-square" style="font-size:150px;"></i></a>
		</div>
