           ...
           <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <ul style="display: block;">
                    <li><a href="${pageContext.request.contextPath}/jsp/CreatCard.jsp"><span>我的名片</span></a></li>
                    <li class="active"><a href="./center-card-other.jsp"><span>收藏名片</span></a></li>
                </ul>
            </li>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/OtherCard.js"></script>
