...
<link href="../css/center-card-other.css" rel="stylesheet" type="text/css">
...
<body>
	...
	<div class="container" id="container1">
		...
		<div class="user-info clearfix">
			...
			<div class="user-info-right">
				...
				<!--25-->
				<p class="about-info">
					<span>${User.sex}</span> <span>${User.city}</span> <span>${User.job}</span>
				</p>
			</div>
	...
	<div class="container">
		<div class="row">
					...
					<ul>
						...
						<li class="nav-item"><a href="javascript:;"><i
							...
							<ul style="display: block;">
								<li><a
									href="${pageContext.request.contextPath}/jsp/center-card-my.jsp"><span>我的名片</span></a></li>
								<li class="active"><a
									href="${pageContext.request.contextPath}/jsp/center-card-other.jsp"><span>收藏名片</span></a></li>
							</ul></li>
			...
			<div class="modal fade" id="cardpannel" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog">
					<div class="modal-content">
							...
							<div class="card">
								...
								<div class="contactinfo">
									<span class="glyphicon glyphicon-phone contact1"
										style="color: #FFFFF0"></span>&nbsp; 手机号: <span
										class="phonenum"></span>
								...
								<div class="emailinfo">
									...
									<span class="glyphicon glyphicon-envelope"
										style="color: #FFFFF0"></span>&nbsp; 邮箱: <span class="email"></span>
								</div>
						...
						<div class="modal-footer">
							...
							<button type="button" class="btn btn-danger" >取消收藏</button>
						</div>
					</div>
					<!-- /.modal-content -->
				</div>
  ...
  $(function () {
	...
	<script type="text/javascript"
		src="${pageContext.request.contextPath}/js/OtherCard.js"></script>
