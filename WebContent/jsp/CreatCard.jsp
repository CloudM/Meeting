				...
				<div class="qrcode-form">
					...
					<div id="qrcode-card">
						...
						<!-- <div class="form-row">
							...
							value="${card.C_username}" placeholder="输入姓名"
...
<%  
					...
					request.setAttribute("name", card.getC_username());
					request.setAttribute("company", card.getC_company());
					request.setAttribute("position", card.getC_position());
					request.setAttribute("phone", card.getC_phone());
					request.setAttribute("email", card.getC_mail());
					request.setAttribute("email", card.getC_introduction());
%>
